    ...
    "paths": {
        ...
        "/encryption/scramble": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Private key and password",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/encryption/unscramble": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Encrypted key and password",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/matching/private-matches-evm": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Private key and EVM address",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/matching/private-matches-public": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Private and public keys",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/matching/public-matches-evm": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Public key and EVM address",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/matching/public-matches-peer": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Public key and peer ID",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/mnemonic/derive-key-full": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Mnemonic with options",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/mnemonic/generate": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Word count (12, 15, 18, 21, or 24)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/signatures/recover-from-digest": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Recover from digest request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/signing/sign-digest": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Sign digest request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/signing/verify-digest": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Verify digest request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "dto.KeyPairResponse": {
            ...
            "properties": {
                ...
                "publicKeyHexUncompressed": {
                    "type": "string",
                    "example": "0x04759b048e7ccf6ba68f9658105a4a139b5f9f5dfd451857c600cc28f33a1a99ae..."
                }
            }
        },
        "dto.KeyTypeResponse": {
        ...
        "dto.RecoverFromDigestRequest": {
            ...
            "properties": {
                "digestHex": {
                    "type": "string",
                    "example": "0x1234567890abcdef...32bytes..."
                },
                "signatureHex": {
                    "type": "string",
                    "example": "0x...65bytes..."
